...
export const skillGroups: SkillGroup[] = [
  ...
  {
    category: "Power Platform & Dataverse",
    skills: [
  ...
  {
    category: "Automation, Integration & Data",
    skills: [
      "Workflow automation",
      "Standard / custom connectors",
      "Azure App Registrations",
      "Data migration & deduplication",
      "Excel / CSV imports & mapping",
      "Integration design",
      "REST API & JSON fundamentals",
    ],
  },
  {
    category: "Security, Governance & ALM",
    skills: [
      "Role-based security",
  ...
  {
    category: "Delivery & Stakeholder Management",
    skills: [
